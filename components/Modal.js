...
const Modal = () => {
    ...
    return (
        <Transition.Root show={open} as={Fragment}>
            ...
            >
                <div className="
                        flex items-end justify-center min-h-[800px]
                        sm:min-h-screen pt-4 pb-20 px-4 text-center sm:block sm:p-0
                    "
                >
                    <Transition.Child
                        as={Fragment}
                            ...
                            <div>
                                ...
                                <div className="mt-5 sm:mt-6">
                                    <button
                                        ...
                                        px-4 py-2 bg-red-600 text-base text-white font-medium hover:bg-red-700 focus-outline-none
